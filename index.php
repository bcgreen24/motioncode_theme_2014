...
<body id="jsn-master" class="<?php echo $this->bodyClass ?>">
	...
	?>
		...
		<div id="jsn-body">
			...
			<?php
			/*====== Show modules in position "Content-bottom-before" ======*/
			if ($jsnutils->countModules('content-bottom-before') > 0) {
			?>
			<div id="jsn-content-bottom-before">
				<div id="jsn-pos-content-bottom-before">
					<jdoc:include type="modules" name="content-bottom-before" style="jsnmodule" />
				</div>
			</div>
			<?php
				}
